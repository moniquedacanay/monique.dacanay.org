...
// 	echo "Test2 Your shoe size is " . $shoeSize . "</br>";
	...
	if (!isset($_GET["dColor"])) {
		...
		echo "Your favorite color is " . $dColor . "</br>";
	}
...
<h2>MySQL Database</h2>
	...
	<h2>Most Popular Color:</h2>
	<p><?php echo $color ?>
	
	<h2>Average Shoe Size:</h2>
	<p><?php echo $avg ?>
	
	<h2>Most Common Dice Roll:</h2>
	<p><?php echo $side ?>
	
	<h2>Who Rolled the Most Dice?:</h2>
	<p><?php echo $name . " with " . $try ?>
	
	<h2>Thought of the Color Green and Has a Shoe Size Less Than 10?:</h2>
	<table><?php echo $d ?></table>


	<section>
		<h5><a href="DiceRollDBFinal.php"
          target="_blank">Click Here To Go Back to the Form!</a></h5>
	</section>
